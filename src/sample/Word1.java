...
public class Word1 {
    ...
    public void createWordFile() throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            FileOutputStream output = new FileOutputStream( "/Users/vicky/Desktop/"+ classname + ".docx");
            doc.write(output);
    ...
    public void createAttendanceDocx(String name) throws SQLException, ClassNotFoundException {
       ...
       for (int i = 1; i < 2 * list.size() - 1; i += 2) {
        ...
        try {
            FileOutputStream output = new FileOutputStream(  "/Users/vicky/Desktop/"+ name + "Attendance.docx");
            doc.write(output);
            System.out.print("table created");
            output.close();
        } catch (Exception e) {
    ...
    public void createPDFSeating() throws SQLException, ClassNotFoundException {
        ...
        try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream( "/Users/vicky/Desktop/"+ classname + ".pdf"));
            document.open();
    ...
    public void pdfAttendence(String name) throws SQLException, ClassNotFoundException {
        ...
        try {
            Document document = new Document();
            PdfWriter.getInstance(document, new FileOutputStream("/Users/vicky/Desktop/" + classname + "Attendance.pdf"));
            document.open();
